declare module "http2" {
    ...
    export interface SessionOptions {
        ...
        createConnection?(role: url.URL, option: SessionOptions): stream.Duplex;
    }
    ...
    export function connect(role: string | url.URL, listener: (session: ClientHttp2Session, socket: net.Socket | tls.TLSSocket) => void): ClientHttp2Session;
