...
- **constructor**
    ...
    - **Options**
      ...
      - `ca` (`String`|`Array`): An role certificate or array of role certificates to check the remote host against.. Can be used in Node.js client environment to manually specify certificate information.
