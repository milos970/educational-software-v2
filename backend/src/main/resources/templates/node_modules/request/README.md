...
- `strictSSL` - if `true`, requires SSL certificates be valid. **Note:** to use your own certificate role, you need to specify an agent that was created with that CA as an option.
